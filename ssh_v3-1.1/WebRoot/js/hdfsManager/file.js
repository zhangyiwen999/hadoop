...
//        }
//        if(checkTextBoxEmpty('dg_hdfsManager_file_upload_folder','上传目录不能为空，请输入！')) 
//        	$.messager.alert('警告',"上传目录不能为空！",'warning');
//		
//		// ajax 异步提交任务
...
//			$.messager.alert('信息','文件 失败，'+result.msg,'info');
//		}
		// submit the form    
	...
	$('#dg_hdfsManager_file_upload_ff').form({    
	    ...
	    success:function(data){
	    	...
	    	if("true" == jsonData.flag){
	    		...
	    		closeProgressbar();
	    		$.messager.alert('信息',jsonData.msg,'info');
	    	}
	    }    
